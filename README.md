...
Testing results are saved in `./result/`， and each result inculdes 8 images, I<subA>, I~M~, I~G~, I~COMP~, I~GT~, I~SAT~, M(I~G~), M(I~GT~), Where the mean of these tokens are in our paper.
